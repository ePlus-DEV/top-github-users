...
The `number of followers` of users in Botswana on `2024/1/31 1:21 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
