...
The `number of followers` of users in Botswana on `2024/1/29 3:18 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
