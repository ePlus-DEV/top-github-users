...
The `number of followers` of users in Peru on `2024/1/30 1:15 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
