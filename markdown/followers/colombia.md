...
The `number of followers` of users in Colombia on `2024/1/30 9:39 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
