...
The `number of followers` of users in Jordan on `2024/1/29 4:17 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
