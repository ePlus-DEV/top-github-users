...
The `number of followers` of users in Cyprus on `2024/1/29 5:17 PM UTC`. This list contains users from `Cyprus` and cities `Nicosia` `Limassol` `Larnaca` `Paphos` `Paralimni` `Famagusta`.
