...
The `number of followers` of users in Venezuela on `2024/1/30 5:32 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
