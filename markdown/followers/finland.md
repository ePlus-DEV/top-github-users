...
The `number of followers` of users in Finland on `2024/1/29 6:29 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
