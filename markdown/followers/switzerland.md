...
The `number of followers` of users in Switzerland on `2024/1/30 3:56 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
