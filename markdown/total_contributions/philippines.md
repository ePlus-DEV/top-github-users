...
The `public contributions` and `private contributions` by users in Philippines on `2024/1/29 8:27 AM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
