...
The `public contributions` and `private contributions` by users in Tanzania on `2024/1/29 11:17 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
