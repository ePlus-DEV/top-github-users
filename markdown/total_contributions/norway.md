...
The `public contributions` and `private contributions` by users in Norway on `2024/1/29 7:35 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
