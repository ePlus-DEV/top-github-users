...
The `public contributions` and `private contributions` by users in Vietnam on `2024/1/30 5:41 AM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.
