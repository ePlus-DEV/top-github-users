...
The `public contributions` and `private contributions` by users in Palestine on `2024/1/30 12:54 AM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
