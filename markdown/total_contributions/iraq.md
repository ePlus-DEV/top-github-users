...
The `public contributions` and `private contributions` by users in Iraq on `2024/1/29 3:02 AM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
