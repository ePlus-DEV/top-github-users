...
The `public contributions` and `private contributions` by users in Jordan on `2024/1/29 9:06 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
