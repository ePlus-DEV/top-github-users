...
The `public contributions` and `private contributions` by users in Ukraine on `2024/1/29 11:56 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
