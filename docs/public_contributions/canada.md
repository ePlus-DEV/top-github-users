...
The `public contributions` by users in Canada on `2024/1/31 10:51 AM UTC`. This list contains users from Canada and cities Toronto Montreal Vancouver Calgary Edmonton Quebeccity Winnipeg Saskatoon Regina.
...
<table>
	...
	<tr>
		...
		<td>Mcgill University </td>
		<td>No Twitter Username</td>
		<td>Montral Canada  Shanghai China</td>
		<td>170</td>
	</tr>
	<tr>
		<td>398</td>
