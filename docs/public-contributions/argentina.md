...
The `public contributions` by users in Argentina on `2025/12/21 3:07 PM UTC`. This list contains users from Argentina and cities Buenosaires Cordoba Rosario Laplata Tucumn Mardelplata Salta Santafe.
...
<table>
	...
	<tr>
		...
		<td>Vordentech </td>
		<td><a target="_blank" href="https://twitter.com/esvdev">esvdev</a></td>
		<td>Buenos Aires Argentina</td>
		<td>111</td>
	</tr>
	<tr>
