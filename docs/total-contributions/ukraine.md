...
The `public contributions` and `private contributions` by users in Ukraine on `2026/4/15 5:58 PM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.
