...
The `public contributions` and `private contributions` by users in Ukraine on `2025/12/14 10:58 AM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.
