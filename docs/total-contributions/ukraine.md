...
The `public contributions` and `private contributions` by users in Ukraine on `2025/12/15 12:51 PM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.
