...
The `public contributions` and `private contributions` by users in Ukraine on `2024/10/16 9:54 AM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.
