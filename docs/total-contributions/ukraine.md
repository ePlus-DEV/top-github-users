...
The `public contributions` and `private contributions` by users in Ukraine on `2026/1/2 3:25 PM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.
