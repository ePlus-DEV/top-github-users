...
The `public contributions` and `private contributions` by users in Ukraine on `2026/3/8 11:34 PM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.
