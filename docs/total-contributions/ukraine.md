...
The `public contributions` and `private contributions` by users in Ukraine on `2026/4/19 10:46 AM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.
