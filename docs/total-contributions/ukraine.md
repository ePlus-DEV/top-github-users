...
The `public contributions` and `private contributions` by users in Ukraine on `2026/4/6 12:47 PM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.
