...
The `public contributions` and `private contributions` by users in Ukraine on `2026/1/8 11:57 AM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.
