...
The `public contributions` and `private contributions` by users in Ukraine on `2026/1/17 11:00 AM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.
