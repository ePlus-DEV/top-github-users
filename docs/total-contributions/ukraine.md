...
The `public contributions` and `private contributions` by users in Ukraine on `2025/12/8 7:52 AM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.
