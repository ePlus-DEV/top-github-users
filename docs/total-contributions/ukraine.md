...
The `public contributions` and `private contributions` by users in Ukraine on `2024/10/23 9:03 PM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.
