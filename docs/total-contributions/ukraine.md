...
The `public contributions` and `private contributions` by users in Ukraine on `2026/1/2 1:45 AM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.
