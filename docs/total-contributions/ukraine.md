...
The `public contributions` and `private contributions` by users in Ukraine on `2026/2/13 11:33 AM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.
