...
The `public contributions` and `private contributions` by users in Ukraine on `2026/4/13 12:11 AM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.
