...
The `public contributions` and `private contributions` by users in Ukraine on `2026/6/27 12:22 PM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.
