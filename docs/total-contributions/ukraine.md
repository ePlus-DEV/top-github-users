...
The `public contributions` and `private contributions` by users in Ukraine on `2026/5/8 11:55 AM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.
