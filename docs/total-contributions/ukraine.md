...
The `public contributions` and `private contributions` by users in Ukraine on `2025/12/17 11:27 AM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.
...
<table>
	...
	<tr>
		<td>284</td>
		<td>
			<a target="_blank" href="https://github.com/ikryvd4">
