...
The `public contributions` and `private contributions` by users in Ukraine on `2026/4/8 11:41 AM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.
