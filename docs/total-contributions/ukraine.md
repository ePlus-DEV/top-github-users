...
The `public contributions` and `private contributions` by users in Ukraine on `2025/12/30 4:23 AM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.
