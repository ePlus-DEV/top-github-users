...
The `public contributions` and `private contributions` by users in Ukraine on `2026/2/16 12:07 AM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.
