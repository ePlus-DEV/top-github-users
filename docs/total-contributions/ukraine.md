...
The `public contributions` and `private contributions` by users in Ukraine on `2025/6/13 10:40 AM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.
