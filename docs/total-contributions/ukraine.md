...
The `public contributions` and `private contributions` by users in Ukraine on `2025/7/16 10:09 AM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.
