...
The `public contributions` and `private contributions` by users in Ukraine on `2025/9/3 8:43 AM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.
