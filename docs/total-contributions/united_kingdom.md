...
The `public contributions` and `private contributions` by users in United Kingdom on `2026/8/27 9:16 AM UTC`. This list contains users from United Kingdom and cities London Birmingham Edinburgh Manchester Glasgow Liverpool Bristol.

There are `19 countries` and `130 cities` can be found [here](https://github.com/ePlus-DEV/top-github-users).

There are `285 users`  in United Kingdom. You need at least `704 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a target="_blank" href="https://github.com/codeWithMarina">
				<img src="https://avatars.githubusercontent.com/u/161620796?s=72&u=352787046b52ff0bf880714881ad97053e8b94e0&v=4" width="24" alt="Avatar of codeWithMarina"/> codeWithMarina
			</a><br/>
			Marina
		</td>
		<td>8allocate </td>
