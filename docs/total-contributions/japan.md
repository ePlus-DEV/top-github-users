...
The `public contributions` and `private contributions` by users in Japan on `2025/5/26 3:38 AM UTC`. This list contains users from Japan and cities Tokyo.

There are `19 countries` and `130 cities` can be found [here](https://github.com/ePlus-DEV/top-github-users).

There are `819 users`  in Japan. You need at least `226 followers` to be on this list.
