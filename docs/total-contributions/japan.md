...
The `public contributions` and `private contributions` by users in Japan on `2026/5/6 8:01 AM UTC`. This list contains users from Japan and cities Tokyo.

There are `19 countries` and `130 cities` can be found [here](https://github.com/ePlus-DEV/top-github-users).

There are `816 users`  in Japan. You need at least `247 followers` to be on this list.
