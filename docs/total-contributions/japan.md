...
The `public contributions` and `private contributions` by users in Japan on `2024/4/6 12:16 PM UTC`. This list contains users from Japan and cities Tokyo.
...
<table>
	...
	<tr>
		<td>195</td>
		<td>
			<a target="_blank" href="https://github.com/hinode7">
