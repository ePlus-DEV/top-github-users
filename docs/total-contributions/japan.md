...
The `public contributions` and `private contributions` by users in Japan on `2024/5/10 7:12 AM UTC`. This list contains users from Japan and cities Tokyo.

There are `19 countries` and `130 cities` can be found [here](https://github.com/ePlus-DEV/top-github-users).

There are `969 users`  in Japan. You need at least `170 followers` to be on this list.
