...
The `public contributions` and `private contributions` by users in Japan on `2024/10/13 12:21 PM UTC`. This list contains users from Japan and cities Tokyo.
...
<table>
	...
	<tr>
		<td>714</td>
		<td>
			<a target="_blank" href="https://github.com/kubo">
