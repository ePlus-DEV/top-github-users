...
The `public contributions` and `private contributions` by users in Japan on `2025/5/22 11:46 PM UTC`. This list contains users from Japan and cities Tokyo.

There are `19 countries` and `130 cities` can be found [here](https://github.com/ePlus-DEV/top-github-users).

There are `789 users`  in Japan. You need at least `234 followers` to be on this list.
