...
The `public contributions` and `private contributions` by users in Japan on `2025/8/8 7:07 AM UTC`. This list contains users from Japan and cities Tokyo.

There are `19 countries` and `130 cities` can be found [here](https://github.com/ePlus-DEV/top-github-users).

There are `842 users`  in Japan. You need at least `227 followers` to be on this list.
