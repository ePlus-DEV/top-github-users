...
The `public contributions` and `private contributions` by users in Japan on `2026/1/23 7:52 AM UTC`. This list contains users from Japan and cities Tokyo.

There are `19 countries` and `130 cities` can be found [here](https://github.com/ePlus-DEV/top-github-users).

There are `955 users`  in Japan. You need at least `217 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a target="_blank" href="https://twitter.com/himkt">himkt</a></td>
		<td>Tokyo Japan</td>
		<td>369</td>
		<td>4007</td>
	</tr>
	...
	<tr>
		<td>331</td>
		<td>
			<a target="_blank" href="https://github.com/HD-Lab00">
