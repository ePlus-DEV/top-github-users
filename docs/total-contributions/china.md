...
The `public contributions` and `private contributions` by users in China on `2026/1/23 4:31 AM UTC`. This list contains users from China and cities Beijing Shanghai Guangzhou Shenzhen Chongqing Chengdu Harbin Tianjin.

There are `19 countries` and `130 cities` can be found [here](https://github.com/ePlus-DEV/top-github-users).

There are `930 users`  in China. You need at least `816 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a target="_blank" href="https://twitter.com/drxmingc">drxmingc</a></td>
		<td>Shanghai</td>
		<td>864</td>
		<td>1265</td>
	</tr>
	...
	<tr>
		<td>718</td>
		<td>
			<a target="_blank" href="https://github.com/ThirtyDegreesRay">
