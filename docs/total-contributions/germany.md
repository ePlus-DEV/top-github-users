...
The `public contributions` and `private contributions` by users in Germany on `2024/2/13 5:18 PM UTC`. This list contains users from Germany and cities Berlin Munich Hamburg Cologne Hamburg Dsseldorf Stuttgart Dresden.

There are `19 countries` and `130 cities` can be found [here](https://github.com/ePlus-DEV/top-github-users).

There are `1747 users`  in Germany. You need at least `275 followers` to be on this list.
