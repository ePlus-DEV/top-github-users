...
The `public contributions` and `private contributions` by users in Canada on `2025/7/11 5:49 PM UTC`. This list contains users from Canada and cities Toronto Montreal Vancouver Calgary Edmonton Quebeccity Winnipeg Saskatoon Regina.

There are `19 countries` and `130 cities` can be found [here](https://github.com/ePlus-DEV/top-github-users).

There are `925 users`  in Canada. You need at least `234 followers` to be on this list.
