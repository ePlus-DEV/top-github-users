...
The `public contributions` and `private contributions` by users in Canada on `2026/4/13 4:36 AM UTC`. This list contains users from Canada and cities Toronto Montreal Vancouver Calgary Edmonton Quebeccity Winnipeg Saskatoon Regina.

There are `19 countries` and `130 cities` can be found [here](https://github.com/ePlus-DEV/top-github-users).

There are `914 users`  in Canada. You need at least `255 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>449</td>
		<td>
			<a target="_blank" href="https://github.com/vasqezai">
		...
		<td>Softgile  </td>
		<td><a target="_blank" href="https://twitter.com/Th3Noryx">Th3Noryx</a></td>
		<td>Toronto</td>
		<td>577</td>
		<td>577</td>
	</tr>
	...
	<tr>
		<td>454</td>
		<td>
			<a target="_blank" href="https://github.com/YusukeM317">
