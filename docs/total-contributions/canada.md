...
The `public contributions` and `private contributions` by users in Canada on `2026/5/2 3:38 PM UTC`. This list contains users from Canada and cities Toronto Montreal Vancouver Calgary Edmonton Quebeccity Winnipeg Saskatoon Regina.

There are `19 countries` and `130 cities` can be found [here](https://github.com/ePlus-DEV/top-github-users).

There are `912 users`  in Canada. You need at least `253 followers` to be on this list.
