...
The `public contributions` and `private contributions` by users in Canada on `2026/6/12 5:57 AM UTC`. This list contains users from Canada and cities Toronto Montreal Vancouver Calgary Edmonton Quebeccity Winnipeg Saskatoon Regina.

There are `19 countries` and `130 cities` can be found [here](https://github.com/ePlus-DEV/top-github-users).

There are `911 users`  in Canada. You need at least `261 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>
			<a target="_blank" href="https://github.com/bomberfish">
				<img src="https://avatars.githubusercontent.com/u/87151697?s=72&u=c1070b6bd6c667aad9ce2f0c8155ccc90aaecd24&v=4" width="24" alt="Avatar of bomberfish"/> bomberfish
			</a><br/>
			Hariz S
		</td>
		<td>Puter Technologies Inc </td>
	...
	<tr>
		...
		<td>
			...
			httpsxcomRMerlinDevEric Sauvageau
		</td>
		<td>No Company</td>
