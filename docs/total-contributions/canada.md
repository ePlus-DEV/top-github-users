...
The `public contributions` and `private contributions` by users in Canada on `2026/3/18 3:00 AM UTC`. This list contains users from Canada and cities Toronto Montreal Vancouver Calgary Edmonton Quebeccity Winnipeg Saskatoon Regina.

There are `19 countries` and `130 cities` can be found [here](https://github.com/ePlus-DEV/top-github-users).

There are `915 users`  in Canada. You need at least `252 followers` to be on this list.
