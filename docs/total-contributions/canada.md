...
The `public contributions` and `private contributions` by users in Canada on `2026/7/10 9:23 PM UTC`. This list contains users from Canada and cities Toronto Montreal Vancouver Calgary Edmonton Quebeccity Winnipeg Saskatoon Regina.

There are `19 countries` and `130 cities` can be found [here](https://github.com/ePlus-DEV/top-github-users).

There are `910 users`  in Canada. You need at least `263 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a target="_blank" href="https://github.com/arcibyte">
				<img src="https://avatars.githubusercontent.com/u/71716787?s=72&u=d5b7d8aaa82ecafd7efbc5afb3e255f67ddc5e5a&v=4" width="24" alt="Avatar of arcibyte"/> arcibyte
			</a><br/>
			Jhon Arciniegas
		</td>
		<td>No Company</td>
