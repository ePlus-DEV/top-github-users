...
The `public contributions` and `private contributions` by users in Canada on `2026/1/7 3:05 AM UTC`. This list contains users from Canada and cities Toronto Montreal Vancouver Calgary Edmonton Quebeccity Winnipeg Saskatoon Regina.

There are `19 countries` and `130 cities` can be found [here](https://github.com/ePlus-DEV/top-github-users).

There are `662 users`  in Canada. You need at least `320 followers` to be on this list.
