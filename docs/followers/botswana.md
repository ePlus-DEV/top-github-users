...
The `number of followers` of users in Botswana on `2024/1/31 4:34 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
