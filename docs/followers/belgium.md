...
The `number of followers` of users in Belgium on `2024/4/1 4:01 PM UTC`. This list contains users from Belgium and cities Antwerp Brussels Ghent Bruges Leuven Lige Namur.
