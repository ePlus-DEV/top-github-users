...
The `number of followers` of users in Belgium on `2024/10/8 8:44 PM UTC`. This list contains users from Belgium and cities Antwerp Brussels Ghent Bruges Leuven Lige Namur.
