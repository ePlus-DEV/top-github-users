...
The `number of followers` of users in Belgium on `2024/8/1 8:34 AM UTC`. This list contains users from Belgium and cities Antwerp Brussels Ghent Bruges Leuven Lige Namur.
