...
The `number of followers` of users in Belgium on `2024/6/6 8:06 AM UTC`. This list contains users from Belgium and cities Antwerp Brussels Ghent Bruges Leuven Lige Namur.
...
<table>
	...
	<tr>
		...
		<td>@modluclouvain  @matgenix <br/><br/></td>
