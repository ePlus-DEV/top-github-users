...
The `number of followers` of users in Belgium on `2025/12/20 2:32 PM UTC`. This list contains users from Belgium and cities Antwerp Brussels Ghent Bruges Leuven Lige Namur.
