...
The `number of followers` of users in Belgium on `2024/8/14 9:47 PM UTC`. This list contains users from Belgium and cities Antwerp Brussels Ghent Bruges Leuven Lige Namur.
