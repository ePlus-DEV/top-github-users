...
The `number of followers` of users in Belgium on `2025/9/11 2:53 PM UTC`. This list contains users from Belgium and cities Antwerp Brussels Ghent Bruges Leuven Lige Namur.
