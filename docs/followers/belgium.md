...
The `number of followers` of users in Belgium on `2025/7/21 12:01 PM UTC`. This list contains users from Belgium and cities Antwerp Brussels Ghent Bruges Leuven Lige Namur.
