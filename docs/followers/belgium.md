...
The `number of followers` of users in Belgium on `2024/4/11 6:22 PM UTC`. This list contains users from Belgium and cities Antwerp Brussels Ghent Bruges Leuven Lige Namur.
