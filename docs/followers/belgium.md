...
The `number of followers` of users in Belgium on `2024/4/1 11:16 AM UTC`. This list contains users from Belgium and cities Antwerp Brussels Ghent Bruges Leuven Lige Namur.

There are `19 countries` and `130 cities` can be found [here](https://github.com/ePlus-DEV/top-github-users).

There are `966 users`  in Belgium. You need at least `38 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>Egonix  Myconsultationbe <br/>Dogdev<br/></td>
		<td>No Twitter Username</td>
		<td>Belgium</td>
		<td>56</td>
	</tr>
	...
	<tr>
		...
		<td>Business Inside Software </td>
		<td>No Twitter Username</td>
		<td>Brussels</td>
		<td>39</td>
	</tr>
