...
The `number of followers` of users in Belgium on `2026/5/10 3:25 AM UTC`. This list contains users from Belgium and cities Antwerp Brussels Ghent Bruges Leuven Lige Namur.

There are `19 countries` and `130 cities` can be found [here](https://github.com/ePlus-DEV/top-github-users).

There are `288 users`  in Belgium. You need at least `142 followers` to be on this list.
