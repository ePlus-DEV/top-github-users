...
The `number of followers` of users in Belgium on `2026/1/16 2:21 AM UTC`. This list contains users from Belgium and cities Antwerp Brussels Ghent Bruges Leuven Lige Namur.
...
<table>
	...
	<tr>
		<td>350</td>
		<td>
			<a target="_blank" href="https://github.com/l145dev">
