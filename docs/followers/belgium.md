...
The `number of followers` of users in Belgium on `2026/1/17 2:10 AM UTC`. This list contains users from Belgium and cities Antwerp Brussels Ghent Bruges Leuven Lige Namur.

There are `19 countries` and `130 cities` can be found [here](https://github.com/ePlus-DEV/top-github-users).

There are `937 users`  in Belgium. You need at least `50 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>217</td>
		<td>
			<a target="_blank" href="https://github.com/xryutaro">
