...
The `number of followers` of users in Belgium on `2026/7/28 9:08 AM UTC`. This list contains users from Belgium and cities Antwerp Brussels Ghent Bruges Leuven Lige Namur.
...
<table>
	...
	<tr>
		<td>910</td>
		<td>
			<a target="_blank" href="https://github.com/fabhar">
