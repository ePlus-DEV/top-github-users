...
The `number of followers` of users in Belgium on `2024/2/27 10:39 AM UTC`. This list contains users from Belgium and cities Antwerp Brussels Ghent Bruges Leuven Lige Namur.
