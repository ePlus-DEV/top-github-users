...
The `number of followers` of users in Belgium on `2026/6/20 4:08 PM UTC`. This list contains users from Belgium and cities Antwerp Brussels Ghent Bruges Leuven Lige Namur.
