...
The `number of followers` of users in Belgium on `2026/7/31 1:45 PM UTC`. This list contains users from Belgium and cities Antwerp Brussels Ghent Bruges Leuven Lige Namur.
