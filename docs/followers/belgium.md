...
The `number of followers` of users in Belgium on `2026/8/10 8:41 AM UTC`. This list contains users from Belgium and cities Antwerp Brussels Ghent Bruges Leuven Lige Namur.
...
<table>
	...
	<tr>
		<td>926</td>
		<td>
			<a target="_blank" href="https://github.com/tombaeyens">
