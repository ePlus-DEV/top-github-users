...
The `number of followers` of users in Belgium on `2024/5/15 10:59 AM UTC`. This list contains users from Belgium and cities Antwerp Brussels Ghent Bruges Leuven Lige Namur.
