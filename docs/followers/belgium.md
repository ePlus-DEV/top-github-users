...
The `number of followers` of users in Belgium on `2024/6/26 6:11 AM UTC`. This list contains users from Belgium and cities Antwerp Brussels Ghent Bruges Leuven Lige Namur.
