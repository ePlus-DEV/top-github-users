...
The `number of followers` of users in Belgium on `2024/5/20 7:49 PM UTC`. This list contains users from Belgium and cities Antwerp Brussels Ghent Bruges Leuven Lige Namur.
