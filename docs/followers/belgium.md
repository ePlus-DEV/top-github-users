...
The `number of followers` of users in Belgium on `2024/2/18 9:43 AM UTC`. This list contains users from Belgium and cities Antwerp Brussels Ghent Bruges Leuven Lige Namur.
