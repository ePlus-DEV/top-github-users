...
The `number of followers` of users in Belgium on `2026/4/11 2:46 AM UTC`. This list contains users from Belgium and cities Antwerp Brussels Ghent Bruges Leuven Lige Namur.

There are `19 countries` and `130 cities` can be found [here](https://github.com/ePlus-DEV/top-github-users).

There are `935 users`  in Belgium. You need at least `50 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>@warrenapp  </td>
		<td><a target="_blank" href="https://twitter.com/klaascuvelier">klaascuvelier</a></td>
		<td>Ghent</td>
		<td>50</td>
	</tr>
</table>
