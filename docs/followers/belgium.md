...
The `number of followers` of users in Belgium on `2024/9/23 5:14 AM UTC`. This list contains users from Belgium and cities Antwerp Brussels Ghent Bruges Leuven Lige Namur.
