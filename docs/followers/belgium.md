...
The `number of followers` of users in Belgium on `2026/5/16 3:21 PM UTC`. This list contains users from Belgium and cities Antwerp Brussels Ghent Bruges Leuven Lige Namur.
