...
The `number of followers` of users in Germany on `2026/2/2 5:23 AM UTC`. This list contains users from Germany and cities Berlin Munich Hamburg Cologne Hamburg Dsseldorf Stuttgart Dresden.

There are `19 countries` and `130 cities` can be found [here](https://github.com/ePlus-DEV/top-github-users).

There are `118 users`  in Germany. You need at least `1720 followers` to be on this list.
