...
The `number of followers` of users in United States on `2026/6/14 2:06 PM UTC`. This list contains users from United States and cities Newyork Chicago Losangeles Sanfrancisco Austin Seattle.

There are `19 countries` and `130 cities` can be found [here](https://github.com/ePlus-DEV/top-github-users).

There are `891 users`  in United States. You need at least `689 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>60</td>
		<td>
			<a target="_blank" href="https://github.com/affaan-m">
		...
		<td>It </td>
		<td><a target="_blank" href="https://twitter.com/affaanmustafa">affaanmustafa</a></td>
	...
	<tr>
		...
		<td>Second State </td>
		<td><a target="_blank" href="https://twitter.com/juntao">juntao</a></td>
		<td>Austin TX USA</td>
		<td>689</td>
	</tr>
	<tr>
