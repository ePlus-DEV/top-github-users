...
The `number of followers` of users in France on `2026/1/23 5:05 AM UTC`. This list contains users from France and cities Paris Marseille Lyon Bordeaux Toulouse Strasbourg Nice Nantes Montpellier Lille.

There are `19 countries` and `130 cities` can be found [here](https://github.com/ePlus-DEV/top-github-users).

There are `84 users`  in France. You need at least `1531 followers` to be on this list.
