...
The `number of followers` of users in Burundi on `2024/1/31 5:05 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
