...
The `number of followers` of users in United Kingdom on `2025/12/15 1:25 PM UTC`. This list contains users from United Kingdom and cities London Birmingham Edinburgh Manchester Glasgow Liverpool Bristol.
