...
The `number of followers` of users in South Korea on `2024/10/14 6:47 AM UTC`. This list contains users from South Korea and cities Seoul Busan Incheon Daegu Ulsan Daejeon.
