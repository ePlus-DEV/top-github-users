...
The `number of followers` of users in South Korea on `2025/5/22 3:47 PM UTC`. This list contains users from South Korea and cities Seoul Busan Incheon Daegu Ulsan Daejeon.
