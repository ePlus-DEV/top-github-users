...
The `number of followers` of users in South Korea on `2025/9/19 6:18 PM UTC`. This list contains users from South Korea and cities Seoul Busan Incheon Daegu Ulsan Daejeon.
