...
The `number of followers` of users in South Korea on `2024/10/15 8:05 AM UTC`. This list contains users from South Korea and cities Seoul Busan Incheon Daegu Ulsan Daejeon.
