...
The `number of followers` of users in South Korea on `2024/3/29 5:32 AM UTC`. This list contains users from South Korea and cities Seoul Busan Incheon Daegu Ulsan Daejeon.
