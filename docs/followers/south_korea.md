...
The `number of followers` of users in South Korea on `2025/6/24 5:05 AM UTC`. This list contains users from South Korea and cities Seoul Busan Incheon Daegu Ulsan Daejeon.
