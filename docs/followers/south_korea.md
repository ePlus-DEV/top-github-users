...
The `number of followers` of users in South Korea on `2024/10/10 8:13 PM UTC`. This list contains users from South Korea and cities Seoul Busan Incheon Daegu Ulsan Daejeon.
