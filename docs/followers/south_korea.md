...
The `number of followers` of users in South Korea on `2024/3/17 5:00 PM UTC`. This list contains users from South Korea and cities Seoul Busan Incheon Daegu Ulsan Daejeon.
