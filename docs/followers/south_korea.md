...
The `number of followers` of users in South Korea on `2025/6/13 9:03 PM UTC`. This list contains users from South Korea and cities Seoul Busan Incheon Daegu Ulsan Daejeon.
