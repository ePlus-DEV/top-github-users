...
The `number of followers` of users in South Korea on `2025/12/20 10:42 PM UTC`. This list contains users from South Korea and cities Seoul Busan Incheon Daegu Ulsan Daejeon.
