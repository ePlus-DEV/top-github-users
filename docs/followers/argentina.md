...
The `number of followers` of users in Argentina on `2025/12/31 1:40 PM UTC`. This list contains users from Argentina and cities Buenosaires Cordoba Rosario Laplata Tucumn Mardelplata Salta Santafe.
...
<table>
	...
	<tr>
		<td>611</td>
		<td>
			<a target="_blank" href="https://github.com/luisinaadp">
	...
	<tr>
		<td>796</td>
		<td>
			<a target="_blank" href="https://github.com/RenzoCav08">
