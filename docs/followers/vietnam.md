...
The `number of followers` of users in Vietnam on `2025/9/16 1:15 PM UTC`. This list contains users from Vietnam and cities Hochiminhcity Hanoi Danang Cantho Haiphong.
