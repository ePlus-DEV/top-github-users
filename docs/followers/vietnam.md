...
The `number of followers` of users in Vietnam on `2025/6/12 2:10 PM UTC`. This list contains users from Vietnam and cities Hochiminhcity Hanoi Danang Cantho Haiphong.
