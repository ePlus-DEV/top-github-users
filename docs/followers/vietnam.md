...
The `number of followers` of users in Vietnam on `2025/9/12 1:04 AM UTC`. This list contains users from Vietnam and cities Hochiminhcity Hanoi Danang Cantho Haiphong.
