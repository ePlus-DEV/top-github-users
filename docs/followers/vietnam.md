...
The `number of followers` of users in Vietnam on `2026/5/9 1:35 PM UTC`. This list contains users from Vietnam and cities Hochiminhcity Hanoi Danang Cantho Haiphong.
...
<table>
	...
	<tr>
		...
		<td>
			...
			0xFFDEAD4E484CBEEF1337C0DECAFE00
		</td>
		<td>No Company</td>
		<td>No Twitter Username</td>
		<td>Vietnam</td>
