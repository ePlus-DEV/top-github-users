...
The `number of followers` of users in Vietnam on `2024/2/13 12:16 PM UTC`. This list contains users from Vietnam and cities Hochiminhcity Hanoi Danang Cantho Haiphong.

There are `19 countries` and `130 cities` can be found [here](https://github.com/ePlus-DEV/top-github-users).

There are `960 users`  in Vietnam. You need at least `29 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>925</td>
		<td>
			<a target="_blank" href="https://github.com/vuongtran">
	...
	<tr>
		<td>934</td>
		<td>
			<a target="_blank" href="https://github.com/tailtq">
