...
The `number of followers` of users in Vietnam on `2025/8/22 11:59 AM UTC`. This list contains users from Vietnam and cities Hochiminhcity Hanoi Danang Cantho Haiphong.
