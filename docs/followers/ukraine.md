...
The `number of followers` of users in Ukraine on `2026/5/31 11:46 AM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.
...
<table>
	...
	<tr>
		<td>534</td>
		<td>
			<a target="_blank" href="https://github.com/zakharkhr">
