...
The `number of followers` of users in Ukraine on `2024/7/22 8:08 AM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.
...
<table>
	...
	<tr>
		<td>965</td>
		<td>
			<a target="_blank" href="https://github.com/trollfacerei">
