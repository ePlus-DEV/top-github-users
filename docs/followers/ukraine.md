...
The `number of followers` of users in Ukraine on `2026/8/13 10:59 AM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.
...
<table>
	...
	<tr>
		<td>654</td>
		<td>
			<a target="_blank" href="https://github.com/Lesia13">
