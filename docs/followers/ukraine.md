...
The `number of followers` of users in Ukraine on `2024/3/15 12:33 AM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.
...
<table>
	...
	<tr>
		<td>974</td>
		<td>
			<a target="_blank" href="https://github.com/belozierov">
